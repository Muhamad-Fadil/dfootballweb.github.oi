    ...
    <div class="container-side">
        ...
        <div class="main-content">
            <div class="container col-md-11 mt-4">
                <h1 class="text-center">TABEL RECAP DATABASE PLAYER</h1>
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                LEFT JOIN overall ON player.rating_id = overall.id
                                ORDER BY player.id;") or die(mysqli_error($koneksi));
                                $no = 1;
                                ...
                                foreach ($datas as $row) {
                                    ...
                                    echo "<td class='text-center'>" . $row['potency'] . "<?td>";
