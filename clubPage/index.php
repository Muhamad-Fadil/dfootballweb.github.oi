    ...
    <div class="container-side ">
        ...
        <div class="main-content">
            <div class="container col-md-10 mt-4">
                <h1 class="text-center">TABEL CLUB PLAYER</h1>
                <div class="card">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                foreach ($datas as $row) {
                                    ...
                                    echo "<td class='text-center'> <img src='../homePage/img/" . $row['logo'] . "'alt='Logo' width='70'></td>";
                                    echo "<td>" . $row['name'] . "<?td>";
                                    echo "<td class='text-center'>" . $row['tahun_berdiri'] . "<?td>";
